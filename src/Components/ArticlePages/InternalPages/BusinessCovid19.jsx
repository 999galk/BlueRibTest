	...
	return(
		<div>
			...
			<div className='article-text'>
				...
				<br/><br/>
				<p style={{textAlign:'center'}}><strong>אין לראות באמור במאמר זה משום ייעוץ משפטי הנוגע לאדם, עסק או מקרה ספציפי. המחבר אינו נושא באחריות כלשהי כלפי מאן דהוא והלה נדרש לקבל עצה מקצועית, פרטנית ויסודית לנסיבות המקרה שלו, לפני כל פעולה המסתמכת על הדברים האמורים ו/או המצורפים להם.</strong></p>
			</div>
		</div>
	);
}
